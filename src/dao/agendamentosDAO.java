...
WHERE  c.status="concluida";
		  ...
		  public static List<AgendamentosCancelados> listarEncerradasFiltradas(
				    String nomeFiltro,
				    String statusFiltro
				) throws Exception {
				    ...
				    while(rs.next()){
				        ...
				        AgendamentosCancelados a =
				            new AgendamentosCancelados();
		  ...
		  public static List<AgendamentosCancelados> listarAgendamentosCancelados() throws Exception {

			    List<AgendamentosCancelados> lista = new ArrayList<>();
