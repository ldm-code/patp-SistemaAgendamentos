...
--
-- Table structure for table `medico_dias_semana`
--

DROP TABLE IF EXISTS `medico_dias_semana`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `medico_dias_semana` (
  `id` int NOT NULL AUTO_INCREMENT,
  `medico_id` int NOT NULL,
  `dia_semana` enum('SEGUNDA','TERCA','QUARTA','QUINTA','SEXTA','SABADO','DOMINGO') NOT NULL,
  PRIMARY KEY (`id`),
  KEY `medico_id` (`medico_id`),
  CONSTRAINT `medico_dias_semana_ibfk_1` FOREIGN KEY (`medico_id`) REFERENCES `medicos` (`id`)
...
-- Dump completed on 2026-04-25 12:26:23
